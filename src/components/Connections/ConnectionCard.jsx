...
const ConnectionCard = ({
    ...
    return (
        <div className="relative w-full max-w-[24rem] sm:max-w-md z-20 group" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
            {/* Massive Deep Background Glow - For visibility on black background */}
            <div className="absolute inset-[-40px] bg-indigo-600/10 rounded-[60px] blur-[100px] opacity-0 group-hover:opacity-100 transition-opacity duration-1000 z-0" />
            ...
            <motion.div
                ...
                className="w-full relative rounded-[40px] flex flex-col cursor-grab active:cursor-grabbing min-h-[600px] p-[1.5px] bg-gradient-to-b from-white/10 via-white/5 to-white/5 shadow-[0_45px_100px_-20px_rgba(0,0,0,1)] group/card"
            >
                ...
                <div className="relative w-full flex-1 bg-[#050505] rounded-[39px] overflow-hidden flex flex-col z-10">
                    {/* Shimmering Surface Effect */}
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/[0.03] to-transparent -translate-x-full group-hover/card:animate-[shimmer_3s_infinite] pointer-events-none" />
                    ...
                    <motion.div style={{ opacity: likeOpacity }} className="absolute顶-10 left-10 z-50 -rotate-12 px-6 py-2 rounded-2xl bg-emerald-500 shadow-[0_0_40px_rgba(16,185,129,0.8)] text-white font-black text-[10px] tracking-[0.2em] uppercase pointer-events-none backdrop-blur-xl scale-110">INTERESTED</motion.div>
                    ...
                    {/* Content */}
                    <div className="relative z-10 flex flex-col items-center flex-1 pt-10 px-8 pb-10">
                        ...
                        <div className="relative mb-6 shrink-0">
                            ...
                            <div className="w-32 h-32 rounded-full p-[2px] bg-gradient-to-b from-white/40 via-white/10 to-transparent shadow-[0_0_40px_rgba(99,102,241,0.2)] relative z-10 transition-all duration-700 group-hover:scale-105 group-hover:shadow-[0_0_60px_rgba(99,102,241,0.4)]">
                        ...
                        <div className="text-center mb-6">
                            ...
                            <h2 className="text-[32px] font-bold text-white tracking-tight leading-none bg-clip-text text-transparent bg-gradient-to-b from-white to-white/70 drop-shadow-2xl capitalize">
                            ...
                            {user.matchReason && (
                                <div className="relative py-1 px-5 w-full">
                                    ...
                                    <div className="space-y-2">
                                        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-cyan-400/90 text-left">Matching Context</p>
                                        <p className="text-[14px] text-white/95 leading-relaxed font-medium text-left line-clamp-3">
                                            {user.matchReason}
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="w-full flex items-center justify-center gap-8 shrink-0 mt-auto pb-4" onPointerDown={(e) => e.stopPropagation()}>
                            <motion.button
                                ...
                                whileTap={{ scale: 0.9 }}
                                className="w-14 h-14 flex items-center justify-center rounded-full bg-white/[0.05] border border-white/20 text-white/20 hover:text-red-400 hover:bg-red-500/10 hover:border-red-500/40 transition-all duration-300 shadow-2xl group"
                            >
                                <X size={24} className="group-hover:drop-shadow-[0_0_8px_rgba(239,68,68,0.6)]" />
                            </motion.button>

                            <button
                                onClick={() => setShowExpertise(true)}
                                className="px-8 py-4 rounded-full text-[11px] font-black uppercase tracking-[0.2em] text-white transition-all duration-300 relative group overflow-hidden bg-white/10 border border-white/20 hover:border-white/40 shadow-2xl hover:shadow-indigo-500/20"
                            >
                            ...
                            <motion.button
                                ...
                                whileHover={{ y: -3, scale: 1.05 }}
                                whileTap={{ scale: 0.9 }}
                                className="w-14 h-14 flex items-center justify-center rounded-full bg-white text-black shadow-[0_10px_30px_rgba(255,255,255,0.3)] hover:shadow-[0_15px_40px_rgba(255,255,255,0.5)] transition-all duration-300"
                            >
