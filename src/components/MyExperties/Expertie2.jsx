    ...
    <div className="bg-white p-1 selection:bg-pink-100">
      <div className="w-full overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-indigo-50/50 via-white to-pink-50/50 shadow-[0_20px_50px_rgba(0,0,0,0.05)] relative border border-white">
        ...
        <div className="flex flex-col md:flex-row min-h-full">
          <aside className="w-full md:w-[280px] lg:w-[320px] bg-gradient-to-br from-indigo-600 via-indigo-500 to-purple-500 p-6 md:p-8 text-white relative overflow-hidden group/aside shrink-0">
            {/* ANAMORPHIC GLOW */}
          ...
          <main className="space-y-8 p-6 md:p-8 relative z-10">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                 ...
                 <span className="text-[9px] font-black uppercase tracking-[0.2em] text-neutral-800">Executive Summary</span>
              </div>
              <h3 className="text-2xl md:text-3xl font-[1000] uppercase italic leading-[1.2] tracking-tighter text-neutral-950">
                {aboutYou}
              </h3>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                  <div className="space-y-8">
                    ...
                    <Section title="Strategic Visions" icon={<Heart size={18} />}>
                      <p className="text-base font-bold leading-relaxed text-neutral-900 max-w-full italic">{interests}</p>
                    </Section>
                  </div>
    
                  <div className="space-y-8">
                    <Section title="High-Impact Units" icon={<Briefcase size={18} />}>
                      <div className="rounded-[1.5rem] border border-neutral-100 bg-white/60 backdrop-blur-sm p-6 font-medium leading-relaxed text-neutral-900 transition-all relative group/card shadow-sm h-full">
                        <div className="relative z-10 whitespace-pre-line">{projects}</div>
                      </div>
                    </Section>
    
                    <Section title="Benchmark Results" icon={<Award size={18} />}>
                      <div className="rounded-[1.5rem] border border-indigo-50 bg-indigo-50/30 p-6 font-bold italic leading-relaxed text-indigo-700 transition-all relative group/card shadow-sm h-full">
...
const Section = ({ title, icon, children }) => (
  <section className="space-y-4 group/sec">
    <div className="flex items-center gap-3">
      ...
      <h4 className="text-[9px] font-black uppercase tracking-[0.2em] text-neutral-800">{title}</h4>
    </div>
